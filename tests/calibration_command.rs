...
const LABELED_FORECASTS: &str = concat!(
    "{\"challenge_id\":\"easy\",\"model_alias\":\"strixtea\",\"capability_card_version\":\"octoroute-strix-capability-card/v1\",\"p_local_success\":0.9,\"capability_boundary\":\"supported\",\"primary_rule\":\"bounded_verification\",\"local_success\":true}\n",
    "{\"challenge_id\":\"hard\",\"model_alias\":\"strixtea\",\"capability_card_version\":\"octoroute-strix-capability-card/v1\",\"p_local_success\":0.1,\"capability_boundary\":\"unsupported\",\"primary_rule\":\"known_local_limit\",\"local_success\":false}\n"
);
